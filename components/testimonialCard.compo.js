...
export default function TestimonialCard({ logo, text, author_photo, author_name, author_position }) {
    return (
        <Link className='block p-[25px] bg-gray-800 align-middle border-0 outline-0 rounded-[8px] cursor-pointer no-underline' href="#">
            ...
            <figure className='flex items-center gap-[10px]'>
                ...
                <cite className='text-gray-400 text-[15px] leading-[27px] -tracking-[0.01em] not-italic'>
